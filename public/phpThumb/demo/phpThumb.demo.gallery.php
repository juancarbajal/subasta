...
$basedir = '/images/';                         // webroot-relative path to main images directory (only this and subdirectories of this will be displayed)
$thumb   = '/demo/phpThumb.php';                    // webroot-relative path to "phpThumb.php"
$popup   = 'phpThumb.demo.showpic.php';  // webroot-relative path to "phpThumb.demo.showpic.php" (only used if $use_popup == true)
$thumbnailsize = 10;                               // size of thumbnails in pixels when browsing gallery
$displaysize   = 100;                               // size of large image display (popup or plain image) after clicking on thumbnail
