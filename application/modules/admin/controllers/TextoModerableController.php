 ...
 * @link     http://kotear.pe/
 */
class Admin_TextoModerableController 
    extends App_Controller_Action_Admin
{
    ...
    {
        Zend_Layout::getMvcInstance()->active = App_Controller_Action_Admin::$m_mant_moderable;
        
        $formFiltroBusqueda = new Application_Form_TextoModerable();
    ...
    public function buscarAction()
    {
        ...
        if (!$this->isAjax) {
            $this->_redirect($this->urlAdmin.'/texto-moderable');
        }
