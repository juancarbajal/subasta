 ...
 * @link     http://kotear.pe/
 */
class Admin_DiccionarioPalabraController
    extends App_Controller_Action_Admin
{
    ...
    {
        Zend_Layout::getMvcInstance()->active = App_Controller_Action_Admin::$m_mant_diccionario;
        
        $formFiltroBusqueda = new Application_Form_DiccionarioPalabras();
        ...
        if ($this->_request->isPost()) {
            ...
            if ($form->isValid($params)) {
                try {
                    ...
                    $dataSave['K_ID_PALABRA'] = $valForm['f_id'];
