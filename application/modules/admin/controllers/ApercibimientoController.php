 ...
 * @link     http://kotear.pe/
 */
class Admin_ApercibimientoController 
    extends App_Controller_Action_Admin
{
    ...
    {
        Zend_Layout::getMvcInstance()->active = App_Controller_Action_Admin::$m_mant_apercibi;
        
        $formFiltroBusqueda = new Application_Form_Apercibimiento();
